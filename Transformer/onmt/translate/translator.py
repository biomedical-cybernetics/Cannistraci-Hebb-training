...
class Translator(object):
        ...
        with torch.no_grad():
            if self.beam_size == 1:
                ...
                decode_strategy = BeamSearch(
                    ...
                    max_length_b=self.max_length_b)
    ...
    def _decode_and_generate(
        ...
        if self.opt.decoder_type == 'ltransformer':
            dec_out = self.model.decoder.cal_dist(dec_out)
    ...
    def _translate_batch_with_strategy(
        ...
        for step in range(decode_strategy.max_length.max()):
