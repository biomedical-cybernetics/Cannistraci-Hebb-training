...
def model_opts(parser):
    ...
    group.add('--task', '-task', type=str, default="iwslt")
    ...
    group.add('--encoder_type', '-encoder_type', type=str, default='rnn',
              choices=['rnn', 'brnn', 'ggnn', 'mean', 'transformer', 'cnn', 'htransformer', 'chttransformer' 
                       ],
    ...
    group.add('--decoder_type', '-decoder_type', type=str, default='rnn',
              choices=['rnn', 'transformer', 'cnn',
                       'htransformer', 'chttransformer'],
              help="Type of decoder layer to use. Non-RNN layers "
                   "are experimental. Options are "
                   "[rnn|transformer|cnn].")
    group.add('--manifold', '-manifold', type=str,
              choices=['poincare', 'lorentz', "Euclidean"])
...
def train_opts(parser):
    ...
    group.add('--save_model', '-save_model', default='model',
              help="Model filename (the model will be saved as "
                   ...
                   "of steps")
    group.add("--no_log", action='store_true')
    ...
    group.add('--optim', '-optim', default='sgd',
              choices=['sgd', 'adagrad', 'adadelta', 'adam', 'radam',
                       'sparseadam', 'adafactor', 'fusedadam', "galore_adamw"],
    ...
    group.add('--amsgrad', '-amsgrad', action='store_true')
    ...
    group.add('--decay_method', '-decay_method', type=str, default="none",
              choices=['inoam', 'noam', 'noamwd', 'rsqrt', 'none'],
...
def translate_opts(parser):
    ...
    group.add('--fp64', '-fp64', action='store_true')
    ...
    group.add('--max_length_a', '-max_length_a', type=float, default=1.2)
    group.add('--max_length_b', '-max_length_b', type=int, default=10)
