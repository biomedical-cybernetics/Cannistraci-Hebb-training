...
def train_model(seed, device, args):
    ...
    if "CH3_L3" in args.regrow_method or "NASI" in args.regrow_method:
    ...
    save_path_parts = [
        ...
        f"s_{args.sparsity}_i_{args.update_interval}_az_{args.adaptive_zeta}_im_{args.init_mode}_um_{args.update_mode}_df_{args.decay_factor}",
    ]
